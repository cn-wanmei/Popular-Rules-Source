...
| adobe-firefly | **REVIEW** | NO_SNAPSHOT | 0 | none |
| adobe-fonts | **REVIEW** | NO_SNAPSHOT | 0 | none |
| adobe-stock | **REVIEW** | NO_SNAPSHOT | 0 | none |
| alibabacloud | **REVIEW** | CANDIDATE | 12 | snap-alibabacloud-461ca160d076aaffa913407c |
| amazonmusic | **REVIEW** | NO_SNAPSHOT | 0 | none |
| anthropic-claude | **REVIEW** | NO_SNAPSHOT | 0 | none |
| anthropic-platform | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| audible | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| chatgpt | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| goodreads | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| huawei-cloud | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| openai-api | **REVIEW** | NO_SNAPSHOT | 0 | none |
| openai-platform | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| quanmin-k-ge | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| stripe-dashboard | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| venmo | **REVIEW** | NO_SNAPSHOT | 0 | none |
...
| xai-grok | **REVIEW** | NO_SNAPSHOT | 0 | none |
